...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "GHLCRM — All-in-one CRM Platform" },
      { property: "og:description", content: "Capture leads, automate marketing, and close more deals with GHLCRM." },
